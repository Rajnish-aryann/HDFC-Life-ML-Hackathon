					...
					<div class="container">
						<a href="index.html" id="branding">
							...
							<!--<div class="logo-text">
								...
								<small class="description"><span style="color:red">Sar uthake jiyo!</span></small>
							</div>
						</a> <!-- #branding -->
					...
					<li data-bg-image="dummy/slide-1.jpg">
						<div class="container">
							<div class="slide-content">
								...
								<p>We are here to provide you with the best life insurance plans. You're just one click away from the button below.</p>
								<a href="insurance.html" class="button">Get an Insurance plan</a>
							</div>
						</div>
					</li>
			...
			<main class="main-content">
				<div class="fullwidth-block greet-section">
					<div class="container">
						...
						<div class="colophon"><center>Copyright 2018 HDFC Life. All rights reserved.</center></div>
					</div>
				</div>
			</div>
		</div>
